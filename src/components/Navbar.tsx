...
export default function Navbar() {
  ...
  // Componente del botón para reutilizarlo en Desktop y Mobile
const ThemeToggle = () => (
    <button
  ...
  return (
    <header className="border-b border-gray-200 bg-white transition-colors duration-300 dark:border-zinc-800 dark:bg-zinc-950 relative z-50">
      <div className="max-w-6xl mx-auto flex items-center justify-between px-6 py-4">
        ...
        {/* Grupo de botones Mobile (Dark Mode + Hamburguesa) */}
